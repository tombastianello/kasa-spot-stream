...
import { readFileSync, rmSync, copyFileSync } from "fs";
...
const getScreenshot = () => {
    if (!streamRunning) {
        ...
        exec("ffmpeg -i http://localhost:8080/video -ss 00:00:01.500 -f image2 -vframes 1 thumb2.jpg").on("close", () => {
            console.log("Thumbnail captured.");
            copyFileSync("thumb2.jpg", "thumb.jpg");
            rmSync("thumb2.jpg");
        });
    }
    setTimeout(() => {
